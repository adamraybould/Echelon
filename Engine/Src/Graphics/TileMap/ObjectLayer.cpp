...
void Core::Graphics::ObjectLayer::CreateEntity(const String& prefab, const Vector2F& position)
{
...
Vector2I Graphics::ObjectLayer::GetObjectPosition(const tmx::Object& obj) const
{
